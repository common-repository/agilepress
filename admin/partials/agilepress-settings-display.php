...
<fieldset class="settings-boxes">
    ...
    <option <?php selected('nixie-one', $agilepress_options['agilepress_note_title_font'], true) ?> value="nixie-one">Nixie One</option>
        <option <?php selected('amatic-sc', $agilepress_options['agilepress_note_title_font'], true) ?> value="amatic-sc">Amatic SC</option>
        <option <?php selected('oswald', $agilepress_options['agilepress_note_title_font'], true) ?> value="oswald">Oswald</option>
        <option <?php selected('josefin-slab', $agilepress_options['agilepress_note_title_font'], true) ?> value="josefin-slab">Josefin Slab</option>
        <option <?php selected('open-sans-condensed', $agilepress_options['agilepress_note_title_font'], true) ?> value="open-sans-condensed">Open Sans Condensed</option>
        <option <?php selected('raleway', $agilepress_options['agilepress_note_title_font'], true) ?> value="raleway">Raleway</option>
        <option <?php selected('roboto', $agilepress_options['agilepress_note_title_font'], true) ?> value="roboto">Roboto</option>
...
<br><br>
    ...
    <select name="agilepress_options[agilepress_note_body_font]" id="note-body-font">
        ...
        <option <?php selected('amatic-sc', $agilepress_options['agilepress_note_body_font'], true) ?> value="amatic-sc">Amatic SC</option>
        <option <?php selected('oswald', $agilepress_options['agilepress_note_body_font'], true) ?> value="oswald">Oswald</option>
        <option <?php selected('josefin-slab', $agilepress_options['agilepress_note_body_font'], true) ?> value="josefin-slab">Josefin Slab</option>
        <option <?php selected('open-sans-condensed', $agilepress_options['agilepress_note_body_font'], true) ?> value="open-sans-condensed">Open Sans Condensed</option>
        <option <?php selected('raleway', $agilepress_options['agilepress_note_body_font'], true) ?> value="raleway">Raleway</option>
        <option <?php selected('roboto', $agilepress_options['agilepress_note_body_font'], true) ?> value="roboto">Roboto</option>
    </select>
</fieldset>
<fieldset class="settings-boxes">
